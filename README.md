...
This repository is a collection of Rust projects created as part of my journey learning the language.  
Most of the projects here are based on exercises and examples from the book **Programming Rust (O'Reilly)**, along with some additional mini-projects I build myself to explore concepts further.
...
- Self-made experiments and mini-projects
- Explorations of Rust libraries, crates, and tooling
...
- A growing body of work that demonstrates my progress in systems programming.
